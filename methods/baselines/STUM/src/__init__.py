...
# Keep package import lightweight.  The original wildcard imports eagerly load every
# optional comparison model (including STGODE, which requires torchdiffeq) even when
# running vanilla STUM.  Import only the components needed by ``train_stum_ori.py``;
# optional comparison models remain available from their own modules.
from .base.engine import BaseEngine
from .stum.STUM import STUM
