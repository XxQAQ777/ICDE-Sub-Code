...
class Solver(object):
    ...
    def _get_data(self, flag):
        ...
        data_set, data_loader = data_provider(
            self.num_workers, self.batch_size, self.traffic_file, self.index_file,
            self.input_len, self.output_len, self.tod, self.dow, flag, log
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--index_file', default = config['file']['index'])
